...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        # Activate modules
        activate_modules('analytic_line_state')
        ...
        self.assertEqual(analytic_account.credit, Decimal('42.00'))
        self.assertEqual(analytic_account.debit, Decimal('0.00'))
        ...
        analytic_account.reload()
        self.assertEqual(analytic_account.credit, Decimal('42.00'))
        self.assertEqual(analytic_account.debit, Decimal('65.00'))
        ...
        self.assertEqual(reconcile_lines.form_state, 'writeoff')
        ...
        self.assertEqual(len(reconcile1.reconciliation.lines), 3)
        writeoff_line1, = [
            l for l in reconcile1.reconciliation.lines
            if l.credit == Decimal(107)
        ]
        writeoff_line2, = [
            l for l in writeoff_line1.move.lines if l != writeoff_line1
        ]
        assertEqual(writeoff_line2.account, expense)
        self.assertEqual(writeoff_line2.debit, Decimal('107'))
